...
export function formatDateHeure(dateReservation, heureReservation) {
...
export function avatarBg(index) { return avatarPalette[index % avatarPalette.length] }
...
export const FILTERS = ['toutes', 'en_attente', 'confirmee', 'terminee', 'annulee']
